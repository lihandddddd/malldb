...
class UserProfileResourceIT {
    ...
    public static UserProfile createEntity() {
        return new UserProfile().phoneNumber(DEFAULT_PHONE_NUMBER).address(DEFAULT_ADDRESS);
    }
    ...
    public static UserProfile createUpdatedEntity() {
        return new UserProfile().phoneNumber(UPDATED_PHONE_NUMBER).address(UPDATED_ADDRESS);
    }
    ...
    public void cleanup() {
        if (insertedUserProfile != null) {
            ...
            userProfileSearchRepository.delete(insertedUserProfile);
    ...
    void createUserProfile() throws Exception {
        ...
        int searchDatabaseSizeBefore = IterableUtil.sizeOf(userProfileSearchRepository.findAll());
        ...
        await()
            ...
            .untilAsserted(() -> {
                int searchDatabaseSizeAfter = IterableUtil.sizeOf(userProfileSearchRepository.findAll());
    ...
    void putExistingUserProfile() throws Exception {
        ...
        updatedUserProfile.phoneNumber(UPDATED_PHONE_NUMBER).address(UPDATED_ADDRESS);
        ...
        await()
            ...
            .untilAsserted(() -> {
                int searchDatabaseSizeAfter = IterableUtil.sizeOf(userProfileSearchRepository.findAll());
                assertThat(searchDatabaseSizeAfter).isEqualTo(searchDatabaseSizeBefore);
                List<UserProfile> userProfileSearchList = Streamable.of(userProfileSearchRepository.findAll()).toList();
