...
describe('Service Tests', () => {
  describe('Product Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new Product(123, 'AAAAAAA', 'AAAAAAA', 0, 0);
    });
    ...
    describe('Service methods', () => {
      ...
      it('should update a Product', async () => {
        const returnedFromService = { name: 'BBBBBB', description: 'BBBBBB', price: 1, stock: 1, ...elemDefault };
      ...
      it('should partial update a Product', async () => {
        const patchObject = { name: 'BBBBBB', description: 'BBBBBB', stock: 1, ...new Product() };
