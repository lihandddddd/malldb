...
import com.custom.mall.service.UserProfileService;
...
/**
 * REST controller for managing {@link com.custom.mall.domain.UserProfile}.
 */
@RestController
...
public class UserProfileResource {
     ...
     */
    @GetMapping("/_search")
    public List<UserProfileDTO> searchUserProfiles(@RequestParam("query") String query) {
